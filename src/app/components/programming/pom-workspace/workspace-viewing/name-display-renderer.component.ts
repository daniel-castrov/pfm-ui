...
@Component({
  template: `<a *ngIf="params.value.id" [routerLink]="['/view-pom-session',params.value.id]">
...
export class NameDisplayRendererComponent implements ICellRendererAngularComp {
