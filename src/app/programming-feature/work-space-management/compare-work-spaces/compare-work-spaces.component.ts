...
import {
  ...
  RowDataStateInterface
} from '../../requests/requests-details/requests-funding-line-grid/requests-funding-line-grid.component';
...
export class CompareWorkSpacesComponent implements OnInit {
  ...
  fundingLines: { [key: string]: FundingLine[] } = {};
  ...
  ngOnInit() {
    ...
    this.program.id = '5ec2d9b96b87bb3b992379f7';
    this.pomYear = 2022;
  ...
  private loadFundingLines() {
    ...
    this.fundingLineService.getByProgramContainerIds(containerIds).subscribe(
      resp => {
        this.fundingLines = (resp as any).result;
      },
      error => {
        this.dialogService.displayError(error.error.error);
      }
